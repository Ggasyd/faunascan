...
#Cette fonction prend juste en entrée , le fichier audio qu'on souhaite ajouter , il faut au préalable que le fichier ait été déja renommé avec le nom d'espèce correct avec des noms sous la forme 
...
def main():
    ...
    result = add_in_index(audio_path)
    print(result)

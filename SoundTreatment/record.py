...
def findpalier(FORMAT, CHANNELS, RATE, CHUNK):
    ...
    while time.time() - start_time < 15: #On enregistre pendant 15sec
    ...
    return rounded+20 #On rajoute 20 décibels captés pour être sûr d'éliminer les petits parasytes
...
def record_audio():
    ...
    outputfold = 'SoundTreatment/audios'
    global stop_recording
    max_silence = 3
    CHUNK = 1024
    ...
    print("Pallier de decibel : " + decibel_palier)
    p = pyaudio.PyAudio()
